...
数字化规划设计-随机项目实践 2010.07 -             :active,    des2, 2010-07,2026-01
...
section C 课程建设
（本3上）软件基础CAAD与创新设计[参数化设计编程] 2014.09 -            :active,    des9, 2014-09,2026-01
（本1下）大学计算机基础[微控制器城市空间实验与C语言] 2017.03 -        :active,    des10, 2017-03,2026-01
（本2上）Python数字设计编程基础 2021.09 -   :active,    des11, 2021-09,2026-01
（研究生课程）数字化设计方法研究 2023.09 -       :    des12, 2023-09,2026-01     
（教育部产学合作协同育人项目）参数化设计数字技术示范课程建设（山水比德） 2022.01 - 2022.12   :active,    des13, 2022-01,2022-12
